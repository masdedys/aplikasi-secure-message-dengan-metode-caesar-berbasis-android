...
public class Inbox extends Activity {
	...
	private void displayListView() {
		Intent i = getIntent();
		Uri uriSMS = Uri.parse("content://sms/" + i.getStringExtra("tipepesan"));
		...
		// jika di pesan di klik, maka akan dialihkan ke baca pesan 
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> listView, View view,
				...
				Intent click = new Intent(Inbox.this, baca.class);
